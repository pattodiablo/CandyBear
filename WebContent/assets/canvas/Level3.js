...
Level3.prototype.create = function () {
	...
	var _menuBtn = this.add.sprite(23.0, 35.0, 'menuBtn');
	...
	var _pipeExit = this.add.sprite(641.0, 697.0, 'pipe', null, _pipes);
	_pipeExit.scale.set(-1.0, 1.0);
	this.game.physics.arcade.enable(_pipeExit);
	_pipeExit.body.immovable = true;
	_pipeExit.body.collideWorldBounds = true;
	...
	var _gunBuyBtn = this.add.sprite(406.0, 665.0, 'gunBuyBtn', null, _buySlot);
	...
	this.add.text(426.0, 727.0, '10', {"font":"bold 20px Arial","fill":"#f0f0f0"}, _buySlot);
	
	this.add.text(647.0, 727.0, '30', {"font":"bold 20px Arial","fill":"#f0f0f0"}, _buySlot);
	...
	var _flavor4 = this.add.text(150.0, 385.0, '2', {"font":"bold 15px Arial","fill":"#5e3056"}, _flavorSlot);
	
	var _flavor5 = this.add.text(150.0, 475.0, '2', {"font":"bold 15px Arial","fill":"#5e3056"}, _flavorSlot);
	
	var _flavor6 = this.add.text(150.0, 563.0, '2', {"font":"bold 15px Arial","fill":"#5e3056"}, _flavorSlot);
	...
	var _coin = this.add.sprite(502.0, 35.0, 'atlas4', 'coin0000');
	...
	var _clientsRemain = this.add.text(446.0, 26.0, '00', {"font":"bold 40px Arial","fill":"#ffffff"});
	_clientsRemain.fixedToCamera = true;
	
	var _cliente = this.add.sprite(420.0, 35.0, 'atlas5', 'cliente10000');
	_cliente.scale.set(0.5, 0.5);
	_cliente.fixedToCamera = true;
	
	var _upperBanner = this.add.group();
	_upperBanner.position.set(0.0, -139.0);
