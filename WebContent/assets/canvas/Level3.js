...
Level3.prototype.create = function () {
	...
	var _menuBtn = this.add.sprite(580.0, 19.0, 'menuBtn');
	...
	this.add.text(583.0, 725.0, '60', {"font":"bold 20px Arial","fill":"#f0f0f0"}, _buySlot);
	...
	var _ballModeBtn = this.add.sprite(560.0, 673.0, 'ballModeBtn', null, _storeGroup);
	
	var _elevatorInn = this.add.sprite(15.0, 845.0, 'elevatorInn');
	_elevatorInn.fixedToCamera = true;
	
	var _upgradeCannon = this.add.sprite(302.0, 846.0, 'upgradeCannon');
