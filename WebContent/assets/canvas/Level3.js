...
Level3.prototype.create = function () {
	...
	this.add.sprite(478.0, 671.0, 'chickRoom');
	
	var _chickRoomUp = this.add.sprite(477.0, 672.0, 'chickRoom');
	...
	this.add.text(499.0, 727.0, '10', {"font":"bold 20px Arial","fill":"#f0f0f0"}, _buySlot);
	
	this.add.text(647.0, 727.0, '30', {"font":"bold 20px Arial","fill":"#f0f0f0"}, _buySlot);
	
	this.add.text(576.0, 725.0, '60', {"font":"bold 20px Arial","fill":"#f0f0f0"}, _buySlot);
	
	this.add.text(419.0, 727.0, '500\n', {"font":"bold 20px Arial","fill":"#f0f0f0","align":"center"}, _buySlot);
